package com.platform.swagger.data;

import com.platform.swagger.model.*;
...
public class PetData {
	...
	static {
		...
		pets.add(createPet(1, categories.get(1), "Cat 1", new String[] {"url1", "url2" }, new String[] { "tag1", "tag2" }, "available"));
